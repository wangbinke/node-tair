  ...
  configServer.retrieveConfigure(groupName, 0, hostList, function (err) {
    ...
    if (requestQueue.length > 0) {
      for (var i = 0; i < requestQueue.length; i++) {
        ...
        exports[method].apply(null, requestQueue[i].args);
      }
      delete requestQueue;
    }
  });
...
exports.set = exports.setEx = function (key, value, expire, namespace, version, callback) {
  ...
  if (!inited) {
    ...
    requestQueue.push({method: 'set', args: Array.prototype.slice.apply(arguments)});
    return;
  }
...
exports.get = function (key, namespace, callback) {
  ...
  if (!inited) {
    //console.warn('Tair: client not init');
    requestQueue.push({method: 'get', args: Array.prototype.slice.apply(arguments)});
    return;
  }
...
exports.mget = function (keys, namespace, callback) {
  ...
  if (!inited) {
    //console.warn('Tair: client not init');
    requestQueue.push({method: 'mget', args: Array.prototype.slice.apply(arguments)});
    return;
  }
...
exports.remove = exports.delete = function (key, namespace, callback) {
  ...
  if (!inited) {
    //console.warn('Tair: client not init');
    requestQueue.push({method: 'remove', args: Array.prototype.slice.apply(arguments)});
    return;
  }
...
function incDec (key, count, namespace, initValue, expire, callback) {
  ...
  if (!inited) {
    //console.warn('Tair: client not init');
    requestQueue.push({method: 'incDec', args: Array.prototype.slice.apply(arguments)});
    return;
  }
  if (key.length >= consts.NAMESPACE_MAX) {
    return callback(null, null);
